...
class GA(Optimizer):
    ...
    def evolve(self, epoch):
        ...
        for i in range(0, int(self.pop_size/2)):
            ...
            ### Mutation
            child1 = self.amend_position(self.mutation_process__(child1), self.problem.lb, self.problem.ub)
            child2 = self.amend_position(self.mutation_process__(child2), self.problem.lb, self.problem.ub)
